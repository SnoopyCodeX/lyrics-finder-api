...
function findLyrics(query) {
    return __awaiter(this, void 0, void 0, function* () {
        const res = yield fetch(`https://genius.com/api/search/multi?q=${encodeURIComponent(query)}`);
        const json = (yield res.json());
        const hits = json.response.sections[0].hits;
        const hit = hits[0].result;
        const lyricsUrl = yield fetch(hit.url);
        const lyricsText = yield lyricsUrl.text();
